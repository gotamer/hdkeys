...
metadata() {
    ...
    echo "Package = 'go.hansaray.pw/hdkeys'" >> metadata.toml 
    echo 'Homepage = "http://go.hansaray.pw/hdkeys"' >> metadata.toml 
    echo "Repo = 'github.com/gotamer/hdkeys.git'" >> metadata.toml 
    ...
    echo 'Documentation = "https://pkg.go.dev/go.hansaray.pw/hdkeys"' >> metadata.toml 
